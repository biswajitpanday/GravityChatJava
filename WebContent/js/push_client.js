...
function loginUser(){
	...
	$(".loginDiv").hide();
	$(".container").show();
	var loginUserDetails = "<div class ='welcomediv'>Welcome <span class='label label-primary'> " + $("#userName").val() + " </span></div> <a href='#' class='btn btn-primary logoutbtn' id='logout'>Logout</a><br><br>";
...
function renderChatDiv(userName){
	...
	"<div class='chatDivTitle'>"+userName+" <a href='#' style='float:right' class='chatClose'><div class='icon-preview'>" +
	"<i class='mdi-content-clear'></i></div></a></div>"+
	"<textarea rows='12' id='chatHistory' class='chatHistory panel-body' readonly='true' cols='30' ></textarea><br>"+
